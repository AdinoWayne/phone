                <div class="navbar-default sidebar" role="navigation">
                	<div class="sidebar-nav navbar-collapse">
                		<ul class="nav" id="side-menu">
                			...
                			<li>
                				<a href="admin/blank"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                			</li>
                			<li>
                      ...
                      <li>
                        <a href="#"><i class="fa fa-cube fa-fw"></i>Product Detail<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                          <li>
                            <a href="admin/productcolor/list">List Product Detail</a>
                          </li>
                          <li>
                            <a href="admin/productcolor/add">Add Product Detail</a>
                          </li>
                        </ul>
                        <!-- /.nav-second-level -->
                      </li>
            ...
            <li>
              <a href="#"><i class="fa fa-users fa-fw"></i> Biểu đồ<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
               <li>
                <a href="admin/bar-chart">Người đăng ký</a>
              </li>
              <li>
                <a href="admin/bar-chart1"> Doanh Thu</a>
              </li>
            </ul>
            <!-- /.nav-second-level -->
          </li>
